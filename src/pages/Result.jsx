...
const AGE_LABELS = {
  ...
  child: '6~9세 초등 저', upper: '10~13세 초등 고',
};
...
const CURRICULUM_MAP = {
  '궁궐': { grade: '초등 5~6학년', code: '[6사05-01]', desc: '조선의 정치와 왕실 문화' },
  '사찰': { grade: '초등 5~6학년', code: '[6사04-02]', desc: '고대 사람들의 생활과 불교문화' },
  '성곽': { grade: '초등 5~6학년', code: '[6사05-02]', desc: '조선 후기 사회·문화적 변화' },
  '고분': { grade: '초등 5~6학년', code: '[6사04-02]', desc: '고대 국가의 형성과 발전' },
  '서원·향교': { grade: '초등 5~6학년', code: '[6사05-01]', desc: '유교 문화의 영향' },
