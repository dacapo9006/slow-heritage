    ...
    const initMap = () => {
      try {
        ...
        new kakao.maps.CustomOverlay({
          map,
          position,
          content: `<div style="background:#0e7490;color:#fff;padding:6px 12px;border-radius:20px;font-size:13px;font-weight:bold;border:2px solid #fff;box-shadow:0 2px 6px rgba(0,0,0,0.3);white-space:nowrap;">${title}</div>`,
          yAnchor: 1.3,
        });
